...
def get_model_params(datasets_path, dataset_name, model_type=None):
    ...
    obj_ids = {
        ...
        "hopeVideo": list(range(1, 29)),
        "SynthStatic": list(range(1, 29)),
        "SynthDynamic": list(range(1, 29)),
        "SynthDynamicOcclusion": list(range(1, 29)),
        "SynthStaticDummy": list(range(1, 29)),
    }[dataset_name]
    ...
    symmetric_obj_ids = {
        ...
        "hopeVideo": None,  # Not defined yet.
        "SynthStatic": None,
        "SynthDynamic": None,
        "SynthDynamicOcclusion":None,
        "SynthStaticDummy": None
    }[dataset_name]
...
def get_split_params(datasets_path, dataset_name, split, split_type=None):
    ...
    # YCB-Video (YCBV).
        ...
        if split == "train":
            ...
            # p["scene_ids"] = list(range(48, 49)) # TODO; remove!!!
