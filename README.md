...
```
conda create -n bop python=3.10
pip install scipy kiwisolver matplotlib imageio pypng Cython PyOpenGL triangle opencv-python Pillow vispy webdataset numpy
pip install -e .
```
Old install
```
